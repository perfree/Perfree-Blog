...
CREATE TABLE `t_article`  (
  ...
  `articleSummary` varchar(256)  NULL DEFAULT NULL COMMENT '文章描述/摘要',
  ...
  `keyword` varchar(256)  NULL DEFAULT NULL COMMENT '关键字',
...
CREATE TABLE `t_attach`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 36 CHARACTER SET = utf8mb4 ;
...
CREATE TABLE `t_category`  (
  ...
  `categoryName` varchar(64)  NOT NULL COMMENT '分类名',
  `categoryIcon` varchar(64)  NULL DEFAULT NULL COMMENT '分类图标',
  `categorySummary` varchar(256)  NULL DEFAULT NULL COMMENT '分类简介',
  `seq` int(11) NOT NULL COMMENT '排序',
  `createTime` datetime(0) NOT NULL COMMENT '创建时间',
  `updateTime` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4  COMMENT = '分类表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_comment`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `context` varchar(2048)  NOT NULL COMMENT '评论内容',
...
CREATE TABLE `t_menu`  (
  ...
  `menuIcon` varchar(64)  NULL DEFAULT NULL COMMENT '菜单图标',
  `menuPath` varchar(64)  NULL DEFAULT NULL COMMENT '菜单路径url',
  ...
  `target` varchar(64)  NULL DEFAULT NULL COMMENT '菜单打开方式',
  `createTime` datetime(0) NOT NULL COMMENT '创建时间',
  `updateTime` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
...
CREATE TABLE `t_role`  (
  ...
  `roleCode` varchar(64)  NOT NULL COMMENT '角色代码',
  `createTime` datetime(0) NOT NULL COMMENT '创建时间',
  `updateTime` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 ;
...
CREATE TABLE `t_user`  (
  ...
  `account` varchar(64)  NOT NULL COMMENT '登陆账户',
